    ...
    *,
    ...
    return schemas.MeasureDetailResponse(
        ...
        measure=schemas.MeasureDetailRead(
            ...
            # infos_analyze
            max_empt_value_l_cu=randrange(0, 60),
            max_empt_value_l_qu=randrange(0, 60),
            max_empt_value_l_ch=randrange(0, 60),
            max_empt_value_r_cu=randrange(0, 60),
            max_empt_value_r_qu=randrange(0, 60),
            max_empt_value_r_ch=randrange(0, 60),
            # analyze_raw
