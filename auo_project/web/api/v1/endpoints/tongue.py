...
async def upload_measure(
    ...
    number: str = Form(..., max_length=128, description="受測者編號 varchar(128)"),
    ...
    tongue_front: UploadFile = File(description="舌象正面圖片"),
    tongue_back: UploadFile = File(description="舌象背面圖片"),
    db_session: AsyncSession = Depends(deps.get_db),
    current_user: models.User = Depends(deps.get_current_active_user),
):
    try:
    ...
    # TODO: check color_hash exists measure.tongue_configs
