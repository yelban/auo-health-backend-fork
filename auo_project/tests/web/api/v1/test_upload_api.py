...
@pytest.mark.anyio
async def test_create_upload(client: AsyncClient, fastapi_app: FastAPI) -> None:
    """
...
@pytest.mark.anyio
async def test_get_upload(client: AsyncClient, fastapi_app: FastAPI) -> None:
    """
...
@pytest.mark.anyio
async def test_cancel_upload(client: AsyncClient, fastapi_app: FastAPI) -> None:
    """
