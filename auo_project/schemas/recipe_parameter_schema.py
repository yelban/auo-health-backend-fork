...
class RecipeAnalyticalParamsInput(BaseModel):
    a001: str = Field(default="all", title="檢測日期", example="all")
    a002: str = Field(default="all", title="介入因子", example="all")
    a003: str = Field(default="all", title="生理性別", example="c023:000")
    a004: str = Field(default="all", title="年齡", example="all")
    a005: str = Field(default="all", title="身高", example="all")
    a006: str = Field(default="all", title="體重", example="all")
    a007: str = Field(default="all", title="BMI", example="all")
    a008: str = Field(default="all", title="疾病史", example="all")
    ...
    a024: str = Field(default="all", title="因上述疾病三個月內持續用藥", example="all")
    a025: str = Field(default="all", title="BCQ得分（正規化）", example="c056:001")
    a026: str = Field(default="all", title="BCQ得分", example="all")
    a027: str = Field(default="all", title="二十八脈", example="all")
    a028: str = Field(default="all", title="血壓", example="all")
    a029: str = Field(default="all", title="血型", example="all")
    a030: str = Field(default="all", title="居住縣/市", example="all")
    # a031: str = Field(title="匹茲堡睡眠量表")
    a032: str = Field(default="all", title="匹茲堡睡眠量表-總分", example="c046:000")
    a033: str = Field(default="all", title="匹茲堡睡眠量表-睡眠品質", example="all")
    a034: str = Field(default="all", title="匹茲堡睡眠量表-睡眠潛伏期", example="all")
    a035: str = Field(default="all", title="匹茲堡睡眠量表-睡眠總時數", example="all")
    a036: str = Field(default="all", title="匹茲堡睡眠量表-睡眠效率", example="all")
    a037: str = Field(default="all", title="匹茲堡睡眠量表-睡眠障礙", example="all")
    a038: str = Field(default="all", title="匹茲堡睡眠量表-安眠藥物使用", example="all")
    a039: str = Field(default="all", title="匹茲堡睡眠量表-日間功能障礙", example="all")
    a040: str = Field(default="all", title="居住型態", example="all")
